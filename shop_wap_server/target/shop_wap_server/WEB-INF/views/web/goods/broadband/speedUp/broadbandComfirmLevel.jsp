...
<div class="container bg-gray hy-tab">
    <form id="handleForm" method="post" action="${ctx}/broadbandSpeedUp/handleSpeedUp">
...
<div class="fix-br">
    <div class="affix foot-box new-foot">
        <div class="container active-fix">
            ...
            <div class="fl-right">
                <%--<a href="javascript:handleSpeedUp()" id="handleSpeedUp">立即办理</a>--%>
                <button id="handleSpeedUp" class="btn btn-rose btn-block">立即办理</button>
            </div>
