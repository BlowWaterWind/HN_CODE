                    ...
                    <div class="discount-list">
                        ...
                        <div class="discount-info">
                            ...
                            <div class="disconunt-box">
                                <p>
                                    <input type="radio" name="boxType"  id='bx' disabled="disabled"  onclick="adc('bx')"  value="1"/>
                                    <span>未来电视(库存不足)</span></label>
                                </p>
                                <p>
                                    <input type="radio" name="boxType" id='bw' checked  onclick="adc('bw')" value="0" />
...
//            var bookInstallTime = $("#bookInstallTime").val();
        ...
        $("#orderComfirm").click(function(){
            ...
            if(isMbh == '1'){
                $("#form1_Mbh").val($("input[name='boxType']:checked").val()||"1");
            }
            //存量转入
            if(isBroadBand == '0'){
                $("#form1").submit();
