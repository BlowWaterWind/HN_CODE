...
<head>
    ...
    <meta name="WT.si_n" content="安装流程" />
...
<div class="container">
   <div class="lc-content">
   	  <p class="lc-tit">用户开户</p>
      <img src="${ctxStatic}/images/broadService/lctu01.jpg" />
      <p class="lc-tit">上门安装</p>
      <img src="${ctxStatic}/images/broadService/lctu02.jpg" />
   </div>
</div>
<!--底部菜单 start-->
<div class="fix-br">
<div class="affix foot-box">
 <ul class="footer-list container">
 	 ...
 	 <li class="active"><a href="javascript:">安装流程</a></li>
