...
<head>
    <%--插码--%>
    <META name="WT.si_n" content="XHJT">
    ...
    <div class="hjt-list">
        ...
        <table class="hjt-table">
            ...
            <tr>
                ...
                </td>                <td class="tr-blue" title="homeVoice">${broadbandItem.homeVoice}</td>
...
//            }
            ...
            var discntCode = parseFloat($(this).find("input[name='discntCode']").val());
