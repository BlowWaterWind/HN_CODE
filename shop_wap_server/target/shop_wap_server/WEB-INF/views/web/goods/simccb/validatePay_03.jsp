...
<div class="container">
    ...
    <!--流程图 start-->
    <div class="tag-box"><img src="${ctxStatic}/images/simccb/tag02.png" /></div>
    <!--流程图 end-->
    <!--表单 start-->
    <div class="form-box">
        <div class="code-box">
    ...
    <form method="post" action="toPay" id="toPay">
        <input type="hidden" name="orderSubNo" value="${orderSubNo}">
    </form>
    <!--表单 end-->
    <div class="gobal-btn">
        <a class="btn btn-blue w50" data-toggle="modal" id="submitBtn">下一步</a>
...
<script type="text/javascript">
    ...
    $("#submitBtn").click(function(){
        ...
        try{
            dcsPageTrack("WT.si_n", "建设银行活动办理", 0, "WT.si_x", "短信确认", 0);//插码使用
        }catch (e) {
            console.log("插码失败")
        }
    });
