...
$(function(){
	...
	$("#submitInstallOrder").click(function(){
	    //点击按钮会触发模态框有三种参数toggle、show、hide 为点击模态框时显示的状态
		//toggle 点击按钮时触发和当前模态框相反的状态
		$("#myModal1").modal();
	});
	/**
	 * 订单确认
	...
	$("#handleComfirmOrder").bind("click",function(){
		...
		showLoadPop();
		$.post(ctx + "/newO2oNewHeBand/newSubmitTempOrder",param,function(data){
