...
<div class="container">
    <form action="newConfirmHeInstall" id="form1" name="form1" method="post">
        ...
        <div class="container active-fix">
            <div class="fl-left">
                <%--<p class="ft-total">初装费：<span class="font-gray6" id="span_total">20元/月</span></p>--%>
                    <p class="ft-total">     <span class="font-gray6" id="span_total">   </span></p>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("tbody>tr").click(function(){
            ...
            // 对插码中的meta标签进行赋值function setO2oNewHeBandMetaValue(skuId,goodsId)
            var goodsId = $("#goodsId").val();
            $("#form1_goodsId").val(goodsId);//对插码需要取得值进行赋值
