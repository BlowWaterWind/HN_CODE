...
<script type="text/javascript">
    var changeUrl="<%=request.getContextPath()%>/newBroadband/getChildrenByPid";
    var submitUrl="<%=request.getContextPath()%>/newBroadband/broadBandBook";
    var gotoSuccessUrl="<%=request.getContextPath()%>/newBroadband/gotoBookInstallSuccess";
    var gotoErrorUrl="<%=request.getContextPath()%>/newBroadband/gotoBookInstallError";
</script>
</body>
</html>