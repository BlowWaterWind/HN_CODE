...
<head>
    ...
    <meta name="WT.si_n" content="${orderTempInfo.goods_name}"/>
...
<div class="cont c_pay">
    <form action="${ctx}/o2oOrder/payOrder" method="post" id="form1">
        <input type="hidden" name="orderTempId" id="orderTempId" value="${orderTempInfo.order_temp_id}">
    ...
    <div class="r r_info">
        <div class="c c-12-12">
            ...
            <dl>
                <dt>订单编号</dt>
                <dd id="tel">${orderTempInfo.order_temp_id}</dd>
                <dt>手机号码</dt>
                <dd id="tel">${orderTempInfo.contact_phone}</dd>
                <dt>套餐名称</dt>
                <dd id="packageName">${orderTempInfo.goods_name}</dd>
                <%--<dt>预存档次</dt>--%>
                <%--<dd id="yeah">x年</dd>--%>
                <dt>支付金额</dt>
                <dd class="price_now" id="amount">￥${orderTempInfo.goods_pay_price/100}元</dd>
                <%--<dt>享受折扣</dt>--%>
    ...
    <div class="r r_pay">
        <div class="c c-12-12">
            <a class="bt_pay" id="zfid">确认支付${orderTempInfo.goods_pay_price/100}元</a>
        </div>
    </div>
</div>
