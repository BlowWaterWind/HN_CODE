...
<div class="container">
    ...
    <div class="collect-con" id="cooResourceList">
    </div>
</div>
</body>
<script type="text/html" id="cooResource">
            ...
            <li>
                <a href="javascript:void(0)" class="collect-icon">
                    <div class="collect-txt">
                        ...
                        <span class="channel-gray9 f12">{{item.cooperationName}}</span>
                    </div>
                    <form action="initAddCooResource" method="post">
...
<script type="text/javascript">
    ...
    function searchList(me) {
        var url = ctx + "o2oBusiCollect/queryCooResourceListByPage";
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data && data.list!=null &&data.list.length>0) {
                    ...
                    var html = template('cooResource', data);
                    var $ul=$(html);
                    $("#cooResourceList .dropload-down").before($ul);
                    ...
                    if(data.pageNo==1&&data.list==null){
                        ...
                        var $li = $(str1);
                        $("#cooResourceList .dropload-down").before($li);
                    }
                    // 锁定
                    me.lock();
                    // 无数据
    ...
    $(function() {
        $("#cooResourceList").dropload(droploadConfig);
    });
</script>
