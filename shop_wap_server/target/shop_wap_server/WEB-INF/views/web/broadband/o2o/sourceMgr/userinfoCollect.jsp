...
<div class="container">
    ...
    <ul class="user-add">
        ...
        <li>
            <label>所在小区</label>
            <div class="user-form">
                <input id="addrDetail" name="addrDetail"  type="text"  class="form-control" placeholder="${o2oCommunityInfoBak.addressPath}" />
            </div>
        </li>
        <li>
            <label>宽带运营商</label>
...
<script type="text/javascript" src="${ctxStatic}/js/o2o/infoCollect/userInfo.js"></script>
