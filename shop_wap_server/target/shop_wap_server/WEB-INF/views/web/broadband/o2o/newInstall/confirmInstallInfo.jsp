...
<head>
    ...
    <script type="text/javascript" src="${ctxStatic}/js/o2o/newinstall/confirmInstall.js"></script>
    ...
    <div class="wf-list sub-info">
        ...
        <div class="wf-ait clearfix sum">
            ...
            <div class="wf-con">
                ...
                <p><span style="color:#f95657">*</span>&nbsp;手机：<span id="span_phoneNum">${installPhoneNum}</span></p>
...
<div class="fix-br">
    <div class="affix foot-box">
        <div class="container active-fix">
            ...
            <div class="fl-right"><a class="share11" id="a_submitInstallOrder" >立即办理</a></div>
    ...
    <div class="share-content sum-con">
        <ul class="share-con">
            <li>
                ...
                <div class="right-td"><input type="text" class="form-control" id="phoneName" name="phoneName" value="${installPhoneNum}" otitle="移动用户手机号码" otype="button" readonly="readonly"/></div>
            </li>
            <li>
