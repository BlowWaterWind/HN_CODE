...
<body>
	...
	<div class="container pd-t45">
		...
		<div class="sm-list floor floor1">
			...
			<div class="sm-con">
				<div class="sm-sic">
					退款金额：<b class="cl-red">￥690.00</b>元
				</div>
				...
				<div class="sm-sic">
					...
					<div class="tc-radio sm-radio">
						<ul class="radio-list">
							<li><label class="tabcon-radio"> <input type="radio" name="sex" class="radio"> 物流问题
							</label></li>
							<li><label class="tabcon-radio"> <input type="radio" name="sex" class="radio"> 商品问题
							</label></li>
							<li><label class="tabcon-radio"> <input type="radio" name="sex" class="radio"> 其他问题
							</label></li>
						</ul>
				...
				<div class="sm-sic">
					...
					<div class="sm-fr">
						<textarea class="ts-kuang">死机、黑屏…</textarea>
					</div>
				</div>
				<div class="sm-sic">
					<span>上传凭证：</span> <a href="#">
						<div class="owl-demo">
							<div class="owl-txt">
								<img src="<%=request.getContextPath()%>/static/images/shop-images/sm.png" />
								<div class="txt"></div>
								<span class="owl-jd">0%</span>
							</div>
							<div class="owl-tu"></div>
							<div class="sc01">
								<img src="<%=request.getContextPath()%>/static/images/shop-images/sm02.png" />
							</div>
						</div>
					</a> <span class="owl-js"><i class="sm-icon"></i>图片大小不超过3M，支持GIF,JPG,PNG,BMP格式</span>
				</div>
			</div>
		</div>
		<!--退货说明 end-->
