...
<% 
	UserBroadbrand brand = (UserBroadbrand)request.getAttribute("band");
%>
<body>
...
<div class="container bg-gray hy-tab">
   <div class="wf-list sub-info wf-fy">
      <div class="wf-ait clearfix">
        <div class="wf-tit wf-zt">
          ...
          <div class="wf-hy">合约期：<%=brand.getStartTime() %>~<%=brand.getEndTime() %></div>
        </div>
      ...
      <div class="renew-btn"><a href="<%=request.getContextPath() %>/" class="btn-new">修改密码</a><a href="<%=request.getContextPath() %>/broadband/linkToRenew" class="btn-new">续费</a></div>
   </div>
</div>
