...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
     <c:choose>
            <c:when test="${not empty message and message!='null'
            and fn:indexOf(message,'exception')<0
            and fn:indexOf(message,'Forbid')<0
            and fn:indexOf(message,'Exception')<0
            and fn:indexOf(message,'For')<0
            and fn:indexOf(message,'input' )<0}">
...
<div class="error-wrap">
    ...
    <div class="error-text">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <p class="mb10">你请求访问的页面，发生错误。</p>
                <p class="mb10">我们建议你返回平台首页进行浏览，谢谢！</p>
            </c:otherwise>
        </c:choose>
