...
public class ValidateCodeServlet extends HttpServlet {
	...
	public static boolean validate(HttpServletRequest request, String validateCode){
		String code = (String) UserUtils.getSession().getAttribute(VALIDATE_CODE);
	...
	private void createImage(HttpServletRequest request,
		...
		UserUtils.getSession().setAttribute(VALIDATE_CODE, s);
...
//			g.drawString(r, i*w/4, h-5);
        ...
        if("DEBUG".equals(Global.getConfig("SEND_SMS_CODE_STATUS"))){
            return "1111";
        }else {
            return s.toString();
        }
