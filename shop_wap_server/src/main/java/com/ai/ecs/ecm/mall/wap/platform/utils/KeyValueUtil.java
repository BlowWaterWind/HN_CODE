 ...
 * 
 * <p>{@code KeyValueUtil}主要提供将key-value字符串转换成{@link Map}的功能{@link #keyValueStringToMap(String) keyValueStringToMap}
 * 和将{@link Map}转换成key-value的功能{@link #mapToString(Map) mapToString}
 * </p>
 * 
 * <p><Strong>设计思路：</Strong>Map转换成key-value字符串时，一次取出每个实体(Entity)，将key与value用“=”连接，每个实体间用“&”连接，
...
public class KeyValueUtil {
	...
	public static void main(String args[]){
		...
		map.put("callSystemId","2000");
		String sign = MD5.sign(mapToString(map),"o5QLVefRcE2PseQpldj1gJgNsD4A1qDdzYNF1SQQ","UTF-8");

		System.out.println(MD5.verify(mapToString(map),sign,"o5QLVefRcE2PseQpldj1gJgNsD4A1qDdzYNF1SQQ","utf-8"));

		System.out.println(mapToString(map)+"sign="+sign);
