...
//import com.ai.ecs.ecsite.modules.broadBand.entity.CommunityInfoCondition;
//import com.ai.ecs.ecsite.modules.broadBand.entity.CommunityInformationCondition;
//import com.ai.ecs.ecsite.modules.broadBand.entity.CommunityUserCondition;
...
//import com.ai.ecs.o2o.entity.O2oCommunityPartnersInfo;
...
// */
//@Controller
//@RequestMapping("bandInfoCollect")
//public class BandInfoCollectController extends BaseController {
//
//    @Autowired
...
//            Map<String,String> hisRecord = Maps.newHashMap();
...
//        }
//        return "web/goods/broadband/infoCollect/infoSearch";
//    }
//
//    /**
...
//        }
//        return "web/goods/broadband/infoCollect/informationCollect";
//    }
//
...
//            logger.error("进入添加盲点小区页失败", e);
//        }
//        return "web/goods/broadband/infoCollect/partnerAndUserCollect";
//    }
//
...
//        model.addAttribute("o2oCommunityInfoBak", o2oCommunityInfoBak);
//        return "web/goods/broadband/infoCollect/partnerInfoCollect";
//    }
//
//    /**
//     * 新增友商信息返回到信息收集页面
...
//        try {
//            MemberVo memberVo = UserUtils.getLoginUser(request);
//            o2oCommunityPartnersInfo.setInsertStaffId(memberVo.getMemberLogin().getMemberPhone());
...
//        model.addAttribute("synchronizedType", synchronizedType);
//        model.addAttribute("eparchy",eparchy);
//        return "web/goods/broadband/infoCollect/userinfoCollect";
//    }
//
//
...
////            condition.setStaffId("SUPERUSR");
////            condition.setTradeDepartPassword("ai1234");
////            condition.setEparchyCode();
...
//        MemberVo memberVo = UserUtils.getLoginUser(request);
//        String insertStaffId = String.valueOf(memberVo.getMemberLogin().getMemberPhone());
//        try {
//            List<O2oCommunityInfoBak> list = o2oCommunityService.selectMyInfo(insertStaffId);
//            model.addAttribute("myInfos", list);
//        } catch (Exception e) {
//            logger.error("增加用户信息失败", e);
//        }
//        return "web/goods/broadband/infoCollect/myInfos";
//    }
//
