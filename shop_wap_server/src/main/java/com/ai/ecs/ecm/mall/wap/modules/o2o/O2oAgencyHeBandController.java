 ...
 */
@Controller
@RequestMapping("o2oAgencyHeBand")
public class O2oAgencyHeBandController extends BaseController {
    @Autowired
    ...
    private Logger logger = Logger.getLogger(O2oAgencyHeBandController.class);
    ...
    public String init(HttpServletRequest request , HttpServletResponse response, Model model,String secToken)  throws Exception {
        ...
        return "web/broadband/o2o/agencyHeFamily/o2oAgencyHeInit";
    }
...
//                查询办理前宽带信息
                ...
                if(broadbandDetailInfoResult!=null&& broadbandDetailInfoResult.getBroadbandDetailInfo()!=null&&"reissue".equals(busType)){
                    ...
                    return "web/broadband/o2o/agencyHeFamily/o2oAgencyHasBroadband";
                }
            }catch (Exception e) {
                e.printStackTrace();
        ...
        return "web/broadband/o2o/agencyHeFamily/o2oAgencyHeChoose";
    }
    ...
    public String confirmHeInstall(HttpServletRequest request,Model model)throws Exception{
        ...
        return "web/broadband/o2o/agencyHeFamily/o2oAgencyHeInstall";
    }
    ...
    public String confirmOrder(HttpServletRequest request, HttpServletResponse response,Model model) throws Exception{
        ...
        return "web/broadband/o2o/agencyHeFamily/o2oAgencyHeConfirmDetail";
    }
