 ...
 */
@Controller
@RequestMapping("o2oNewHeBand")
public class O2oNewHeBandController extends BaseController {
    @Autowired
    ...
    private Logger logger = Logger.getLogger(O2oNewHeBandController.class);
    ...
    public String init(HttpServletRequest request , HttpServletResponse response, Model model,String secToken)  throws Exception {
        ...
        String openCity=request.getParameter("openCity");
        //获取办理用户手机号码
        ...
        model.addAttribute("openCity",openCity);
        return "web/broadband/o2o/newHeFamily/o2oNewHeInit";
    }
    ...
    public String bandInstall(HttpServletRequest request,Model model) throws Exception {
        ...
        try {
            ...
            throw new Exception("查询用户账号信息失败!");
        }
        //有宽带未进入地址页面
...
//                查询办理前宽带信息
                ...
                if(broadbandDetailInfoResult!=null&& broadbandDetailInfoResult.getBroadbandDetailInfo()!=null&&"reissue".equals(busType)){
                    ...
                    return "web/broadband/o2o/newHeFamily/o2oHasBroadband";
                }
            }catch (Exception e) {
                e.printStackTrace();
        ...
        ChannelInfo channelInfo = memberVo.getChannelInfo();
        boolean isLY=false;
        if(BroadbandConstants.CITY_CODE_OF_LIUYANG.equals(channelInfo.getCityCode())&&"LY".equals(openCity)){
            isLY=true;
        }
        for(BroadbandItemEntity entity:heBroadbandItemList){
            ...
            if(isLY&&Integer.valueOf(entity.getDiscntCode())>169){
                entity.setBandWidth(100L);
            }
        }
        ...
        return "web/broadband/o2o/newHeFamily/o2oNewHeChoose";
    }
    ...
    public String confirmHeInstall(HttpServletRequest request,Model model)throws Exception{
        ...
        return "web/broadband/o2o/newHeFamily/o2oNewHeInstall";
    }
    ...
    public String confirmOrder(HttpServletRequest request, HttpServletResponse response,Model model) throws Exception{
        ...
        return "web/broadband/o2o/newHeFamily/o2oNewHeConfirmDetail";
    }
