    ...
    <div class="channel-entry">
        <form method="post" id="partnerInfoForm" action="addPartnerInfo">
            ...
            <div class="entry-list">
                ...
                <div class="posted-list">
                    <p class="posted-box">
                        ...
                        <input id="partnerName" type="text" maxlength="100" class="form-control" placeholder="友商名称"  readonly="readonly"/>
                    </p>
                </div>
            </div>
            <!--宽带覆盖情况 start-->
            ...
            <div class="entry-list">
                ...
                <div class="posted-list">
                    <p class="posted-box">
                        <input id="userNum" name="userNum" type="number" oninput="if(value.length>10)value=value.slice(0,10)" class="form-control" placeholder="输入宽带客户数量"/>
                    </p>
                </div>
            </div>
            <!--宽带客户数量 end-->
...
<script type="text/javascript" src="${ctxStatic}/js/goods/broadband/infoCollect/partnerInfo.js"></script>
