...
<div class="container">
    ...
    <!--流程图 start-->
    <div class="tag-box"><img src="${ctxStatic}/images/spdbsim/tag03.png"/></div>
    <!--流程图 end-->
    ...
    <!--支付方式 end-->
    <div class="gobal-btn">
        <a class="btn btn-rose w50" data-toggle="modal" id="submitBtn">确认支付￥${orderSub.orderSubPayAmount/100}</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <p class="t-c">支付超时<br>请重新办理活动<br>具体请咨询10086<br></p>
            </div>
...
<!--弹框 end-->
<!--弹框 start-->
<div class="modal fade gobal-modal" id="myModal01" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <p class="t-c">支付失败<br>请重新支付<br>具体请咨询10086<br></p>
            </div>
            <div class="modal-footer"><a class="btn btn-rose w50" data-dismiss="modal">结束</a></div>
        </div>
    </div>
...
<script type="text/javascript">
    $("#submitBtn").click(function () {
        ...
        $.ajax({
            ...
            dataType:'json',
            type:'post',
            data:{orderNos:$("#orderNos").val(),radiocode:radiocode,bankType:"SPDB"},
            success:function(data){
                if(data.code == '0'){
                    ...
                    toggleModal('myModal',data.message,'去解冻保证金',url);
                }
            },
            error:function(){
