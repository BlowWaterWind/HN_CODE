    	...
    	if(ua.match(/leadeon/i)=="leadeon"){
            //走手厅
	           ...
	           /* document.write('<script type="text/javascript" src="${ctxStatic}/js/qm/sdc9.js"><\/script>');*/
	            document.write('<script type="text/javascript" src="${ctxStatic}/js/qm/insdc_w3.js"><\/script>');
	      }
    </script>
</head>
	...
	<c:if test="${isMbh == '1'}">
	        ...
	        <div class="wf-ait clearfix">
	            ...
	            <ul class="wf-con change-view mt10">
	            	<li><label><div class="view-box"><input type="radio" id='wl' checked="checked" name="form1_Mbh" value="1"  disabled="disabled"/><b>未来TV</b> </div><small class="font-gray">央视连续剧、少儿动漫、极光专区、超级回看中的电影。</small></label></li>
	            	<li disabled="disabled"><label><div class="view-box"><input  type="radio" id='mg'  name="form1_Mbh"  checked="checked" value="0"/><b>芒果TV</b></div><small class="font-gray">湖南自制剧、热播电影、综艺、电影片库、动漫等。</small></label></li>
	            </ul>
	        </div>
	        <!--选择品牌 end-->
        </div>
