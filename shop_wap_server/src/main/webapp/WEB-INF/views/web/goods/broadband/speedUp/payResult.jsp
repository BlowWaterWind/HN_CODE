...
<div class="container bg-gray hy-tab">
    <div class="suess-con">
        ...
        <div class="suess-list">
            <c:choose>
                <c:when test="${record.respCode=='0'}">
                    <p class="text-center suess-tit font-blue">订单号 ${record.recordId} 提速成功，现在开始享受${record.newBandWidth}光速带宽!</p>
                </c:when>
                <c:otherwise>
                    <p class="text-center suess-tit font-blue">您的订单支付失败，请您重试，或致电客服10086!</p>
                </c:otherwise>
            </c:choose>
            <p>订单编号：<b class="font-rose">${record.recordId}</b></p>
            <p>价&nbsp;&nbsp;格：<b class="font-rose">￥${record.payAmount/100}元/月</b></p>
