...
<div class="container bg-gray hy-tab">
  <div class="Tab">
    ...
    <div class="wf-ait clearfix">
      <div class="wf-tit wf-zt"> <a href="网厅-宽带专区-我的宽带-宽带详情.html">
        <div class="wf-zm"><span class="pull-left">宽带账号：<%=brand.getBroadbandAccount() %></span><span class="pull-right font-red"><%=DateUtils.timeToNowDate(brand.getEndTime()) %>天后过期</span></div>
        <div class="wf-hy">
          <span class="sus-tit">合 约 期：</span>
          <span class="sus-text"><%=brand.getStartTime() %>~<%=brand.getEndTime() %></span>
        </div>
      ...
      <div class="wf-con kd-renew-con">
        ...
        <div class="renew-btn"><a href="网厅-宽带专区-宽带提速.html" class="btn-new">提速</a><a href="网厅-宽带专区-密码修改.html" class="btn-new">修改密码</a><a href="网厅-宽带专区-宽带续费.html" class="btn-new">续费</a></div>
      </div>
    </div>
 <% }} %>
