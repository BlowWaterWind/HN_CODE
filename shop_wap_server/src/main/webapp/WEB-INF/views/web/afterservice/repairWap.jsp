...
<script type="text/javascript">
	$(document).ready(function() {
		var typeReqPath = "typeRequestPath="+$("#asServerTypeId").val();
		///alert(typeReqPath);
		//var submitPath = $("#serverType").val()+"_"+$("#serverName").val();
		$.ajax({
		    type: "post",
		    url: "initData",
		    data:{"asServerTypeId":$("#asServerTypeId").val()},
		    dataType: "json", 
		    error:function(data){  
	            alert("retGoodWap.jspp出错了！！:"+data.msg);  
	        }, 
			...
			<div class="sm-con">
				<div class="sm-sic">
					...
					<div class="tc-radio sm-radio">
						...
						<span class="tc-title">*请选择你的维修原因</span>
					</div>
				</div>
				<div class="sm-sic">
					<span class="ty-st">维修说明：</span>
					<div class="sm-fr">
						<textarea class="ts-kuang">不能超过500字</textarea>
					</div>
				</div>
				<div class="sm-sic">
					<span>上传凭证：</span> 
