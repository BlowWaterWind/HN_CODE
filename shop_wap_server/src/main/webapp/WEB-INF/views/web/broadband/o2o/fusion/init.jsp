	...
	<div class="wf-list change-info sub-new">
		<div class="wf-ait clearfix">
			<c:choose>
				...
				<c:when test="${busiType == 1}">
					<c:if test="${minCost == 48}">
						<dl>
							<dt><img src="${ctxStatic}/images/kd/familynet-logo.jpg"/></dt>
							<dd>
								<h4>${minCost}元保底套餐</h4>
				...
				<c:when test="${busiType == 2}">
					<c:if test="${minCost == 98}">
						<dl>
