...
<form action="${ctx}/o2oBroadFusion/index" id="form1" method="post">
<input type="hidden" name="hasAddress" value="Y"/>
...
<div class="fix-br">
    <div class="affix foot-box">
        <div class="container active-fix">
        	<a href="javascript:void(0);" class="btn btn-rose" id="confirm">使用该地址</a>
