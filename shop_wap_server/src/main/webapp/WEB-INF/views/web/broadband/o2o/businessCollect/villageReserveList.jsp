...
<div class="container">
    ...
    <div class="collect-con" id="villageList">
    </div>
</div>
</body>
<script type="text/html" id="village">
    <ul class="adress-list-box">
    {{each list as village}}
            <li>
...
<script type="text/javascript">
    ...
    function searchList(me) {
        var url = ctx + "o2oBusiCollect/queryVillageListByPage";
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data && data.list!=null &&data.list.length>0) {
                    ...
                    var html = template('village', data);
                    var $ul=$(html);
                    $("#villageList .dropload-down").before($ul);
                    ...
                    if(data.pageNo==1&&data.list==null){
                        ...
                        var $li = $(str1);
                        $("#villageList .dropload-down").before($li);
                    }
                    // 锁定
                    me.lock();
                    // 无数据
    ...
    $(function() {
        $("#villageList").dropload(droploadConfig);
    });
</script>
