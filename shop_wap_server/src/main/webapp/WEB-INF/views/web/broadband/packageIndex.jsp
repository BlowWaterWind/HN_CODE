...
<div class="top container">
    <div class="header border-bottom"><a class="icon-main-back" href="javascript:void(0);" onclick="window.history.back()"></a>
        <h1>宽带地址查询</h1>
        <a href="javascript:void(0)" class="relefresh-btn channel-gray3" id="queryCommunityInfo">小区信息收集</a>
    </div>
</div>
...
<div class="container">
    ...
    <div class="borad-selected">
        <div class="selected-list">
            <a href="javascript:void(0)" class="selected-link collent item">
                <img src="images/kdtu.jpg" class="selected-img" />
