...
<head>
    ...
    <script type="text/javascript" src="${ctxStatic}/js/o2o/heFamily/o2oConfirmHeInstall.js"></script>
...
<form id="form1" name="form1" action="confirmHeOrder" method="post">
    <input type="hidden" id="form1_skuId" name="form1_skuId"  value="${broadbandItem.goodsSkuId}"/>
    <input type="hidden" id="form1_goodsName" name="form1_goodsName"  value="${broadbandItem.broadbandItemName}"/>
                                ...
                                <div class="right-td">
                                    <div class="td-fr"><i class="select-arrow"></i>
                                        <select id="bookInstallTime" name="bookInstallTime" class="form-control">
                                            ...
                                            <option value="3">12:00:00-14:00:00</option>
                                            <option value="4">14:00:00-18:00:00</option>
                                            <option value="5">18:00:00-20:00:00</option>
                                        </select>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="wf-ait clearfix">
            <ul class="bar-list">
                <li style="height:30px;line-height:25px;">
                    ...
                    <div class="sub-text">
                        <a href="javascript:void(0);" class="bar-btn active" onclick="choosePayMode('0','现金支付',this)">现金支付</a>
    ...
    <div class="fix-br">
        <div class="affix foot-box">
            <div class="container active-fix">
                ...
                <div class="fl-right"><a class="share11" id="a_submitInstallOrder1">立即办理</a></div>
        ...
        <div class="share-content sum-con">
            <ul class="share-con">
                <li>
                    ...
                    <div class="right-td">${installPhoneNum}</div>
                </li>
                <li>
