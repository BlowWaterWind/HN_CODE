...
<form method="post" id="keepCommuntyInfo">
    ...
    <%--<input type="hidden" name="communityName" value="${o2oCommunity.communityName}">--%>
        ...
        <div id="tab-1">
          ...
          <select id="road" class="set-sd road-area" name="road">
              <%--<option value="岳麓区">岳麓区</option>--%>
                ...
                <input type="hidden" name="addressPath" value="${o2oCommunity.addressPath}">
                <%--<input type="hidden" name="resourceSrc" value="${o2oCommunity.resourceSrc}">--%>
                <input type="hidden" name="synchronizedType" value="0">
                <ul class="user-add">
                    <li>
                        <label>地址类型1:</label>
                    ...
                    <li>
                        <label>小区名称</label>
                        <div class="user-form">
                            <input id="zoneName" name="zoneName" type="text" class="form-control" maxlength="40"
                    ...
                    <li>
                        <label>楼宇数量</label>
                        <div class="user-form">
                            <input id="buildingNum" name="baBuildingCnt" type="number" class="form-control" maxlength="8"
                    ...
                    <li>
                        <label>反馈者姓名</label>
                        <div class="user-form">
                            <input id="FEEDBACK_PERSON" name="feedbackPerson" type="text" class="form-control" maxlength="10"
                    ...
                    <li>
                        <label>反馈者号码</label>
                        <div class="user-form">
                            <input id="FEEDBACK_MOBILE" name="feedbackMobile" type="text" class="form-control" maxlength="15"
...
<!--输入密码弹框 start-->
<div class="modal modal-prompt" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
...
<script type="text/javascript" src="${ctxStatic}/js/o2o/infoCollect/infoCollect.js"></script>
...
<script type="text/javascript">
    ...
    $(function () {
        if (infoType == '2') {
            //注入小区的信息
            <%--$("#opera").html('${o2oCommunity.baAddrType}');--%>
