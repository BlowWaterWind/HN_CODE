...
<div class="container">
  <div class="new-poplist clearfix">
  	<table cellpadding="0" cellspacing="0" class="new-tabs">
  	  ...
  	  <tr>
  	  	<td class="tr">联系电话：</td>
  	  	<td class="tl" id="td_phoneNum">${form1_phoneNum}</td>
  	  </tr>
		  	  <tr>
		  	  	<td class="tr">装机地址：</td>
...
$(function(){
	...
	$("#handleComfirmOrder").bind("click",function(){
		...
		showLoadPop();
		$.post(ctx + "/o2oHeBand/submitTempOrder",param,function(data){

			if(data.code=="0"){
				//$("#payForm_orderSubNo").val(data.orderSub.order_temp_id);
				//$("#span_price").text(data.orderSub.goods_sku_price/100);
				//$("#b_goodsName").text(data.orderSub.goods_name);
...
//			else if(data.code=="2"){
//				hideLoadPop();
//				window.location.href= ctx + "o2oHeBand/tempResult";
//			}
			else {
				hideLoadPop();
				if(data.message!=''){
