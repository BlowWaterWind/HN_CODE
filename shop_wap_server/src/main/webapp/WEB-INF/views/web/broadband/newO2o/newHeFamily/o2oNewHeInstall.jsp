...
<head>
    ...
    <%--插码--%>
    <meta name="WT.si_n" content="XHJT_DKYCK"/>
...
<div class="container">
    <form action="newConfirmHeInstallDetail" id="form1" name="form1" method="post">
        ...
        <%--插码相关取值传递--%>
        <input type="hidden" id="form1_goodsId" name="form1_goodsId" value="${goodsId}"/>
...
<div class="fix-br new-fixed">
    <div class="affix foot-box">
        <div class="container active-fix">
            <div class="fl-left">
                <p class="ft-total">  <span class="font-gray6">  </span></p>
                <%--<c:choose>--%>
                    <%--<c:when test="${hasBroadband == '1'}">--%>
                        <%--<p class="ft-total">初装费：¥<span class="font-gray6">- -</span></p>--%>
                    <%--</c:when>--%>
                    <%--<c:otherwise>--%>
...
<script>
    ...
    $(function () {
        // 插码setO2oNewHeBandMetaValue(skuId,goodsId)
        var skuId = $("#form1_skuId").val();
        var goodsId = $("#form1_goodsId").val();
        setO2oNewHeBandMetaValue(skuId,goodsId);
        //切换
