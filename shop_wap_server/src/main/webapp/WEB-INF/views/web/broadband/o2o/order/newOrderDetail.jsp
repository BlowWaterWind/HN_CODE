        ...
        <div class="list order-info_wrap">
            <div class="order-info"><i class="icon-time"></i>
                ...
                <div class="order-info_ft">
                    ...
                    <div class="mr-20" onclick="queryWorkSheet()">查看进度详情</div><i class="caret-right"></i>
                    </c:if>
                    </div>
            </div>
    ...
    <div class="footbtn">
        ...
        <c:if test="${broadbandOrder.tradeTypeCode eq '1002'}">
            ...
            <c:if test="${not empty broadbandOrder.preInstallDate and broadbandOrder.tradeStatus ne '系统完工'}">
                <a href="javascript:void(0)" class="btn btn-default btn-timePicker" style="background-color: #fff;">更改预约</a>
            </c:if>
...
<form id="queryWorkSheetForm" name="queryWorkSheetForm" action="${ctx}/o2oOrder/queryWorkSheet" modelAttribute="broadbandOrder" method="post">
    ...
    <input type="hidden" name="tradeId" id="tradeId" value="${broadbandOrder.tradeId}"/>
...
<script type="text/javascript">
    ...
    function modifyTime(){
        ...
        var bandAccount=$("#accNbr").val();
        var installTime = $("#preInstallDate").val();
