...
<div class="container">
    <form action="confirmInstall" id="form1" name="form1" method="post">
        ...
        <input type="hidden"  name="serialNumber" value="${broadbandFusionBean.serialNumber}"/>
            ...
            <div class="entry-list">
                ...
                <ul class="entry-form">
                    ...
                    <li>
                        <label>手机号码</label>
                        <div class="entry-rt">
                            <input type="text" class="entry-box" id="serialNumber" value="${serialNumber}" readonly/>
...
//            var bookInstallTime = $("#bookInstallTime").val();
        ...
        $("#orderComfirm").click(function(){
            ...
            if(isMbh == '1'){
                $("#Mbh").val($("input[name='boxType']:checked").val()||"0");
            }
            var messege = "";
            var pattern = /^[\u4E00-\u9FA5]{1,8}$/;
