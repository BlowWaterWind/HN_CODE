                    ...
                    if (data.code == '0') {
                        ...
                        showAlert(data.message, function () {
                            ...
                            if(synchronizedType == '0'){
                                window.location.href = ctx+"/infoCollect/initAdd?communityId="+communityId+"&infoType=2&tab=tab3";
                            }else{
                                window.location.href = ctx+"/infoCollect/initAddPartnerOrUser?communityId="+communityId+"&type=1&tab=tab3";
                            }
                        });
                    } else {
                        hideLoadPop();
