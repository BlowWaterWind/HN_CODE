/**
 * Created by hewei on 2017/9/2/002.
 */
...
//提示弹框
var toggleModal = function (id, prompt1, prompt2) {
    var thisId = "#" + id;
    if ($(thisId)) {
        if (prompt1 == null || prompt1.length == 0)
            prompt1 = prompt2;
        if(prompt1 != null && prompt1.indexOf("，")>0) {
            var strs = new Array();
 ...
 * 字符串中不含空格
 */
var isContainSpace = function(str){
    if (str.indexOf(" ") == -1) {
        return false;
    }
    return true;
